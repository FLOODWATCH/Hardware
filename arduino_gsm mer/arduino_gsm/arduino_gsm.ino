...
//---------CODE START-----------------------------------------------------------
  ...
  String display;
  if(distance > 90 || distance == 0){ //greater than 4 meters
    digitalWrite(9, LOW);
    digitalWrite(10, LOW);
    digitalWrite(11, LOW);
    digitalWrite(12, LOW);
  ...
  }else if(distance > 67 && distance <= 90 ){ //greater than 3 meters and less than or equal to 4 meters
    digitalWrite(9, HIGH);
    digitalWrite(10, LOW);
    digitalWrite(11, LOW);
    digitalWrite(12, LOW);
  ...
  }else if(distance > 45 && distance <= 67){ //greater than 2 meters and less than or equal to 3 meters
    digitalWrite(9, LOW);
  ...
  }else if(distance > 22 && distance <= 45){ //greater than 1 meter and less than or equal to 2 meters
    digitalWrite(9, LOW);
    digitalWrite(10, LOW);
  ...
  }else if(distance > 0 && distance <= 22 ){ //less than or equal to 1 meter
    digitalWrite(9, LOW);
    digitalWrite(10, LOW);
    digitalWrite(11, LOW);
